...
WITH base AS (
    ...
    FROM `dlt-dev-external.dwh_github_vfs_raw_20230731050204.pull_requests__reviews__nodes__comments__nodes` PRRRC 
    JOIN `dlt-dev-external.dwh_github_vfs_raw_20230731050204.pull_requests__reviews__nodes__comments__nodes__reactions__nodes` PRRRCR 
